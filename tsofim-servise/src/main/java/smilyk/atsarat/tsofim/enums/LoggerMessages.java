package smilyk.atsarat.tsofim.enums;
 ...
 public abstract class LoggerMessages {
     ...
     public static final String PASSWORD_ENCODE = " password encoded " ;
     public static final String FOR_CHILD = " for child ";
     public static final String WITH_UUID = " with UUID: ";
     public static final String WAS_SAVE = " was save in DB";
