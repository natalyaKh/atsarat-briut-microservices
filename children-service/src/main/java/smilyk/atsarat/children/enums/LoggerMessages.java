package smilyk.atsarat.children.enums;
 ...
 public abstract class LoggerMessages {
     ...
     public static final String RESP_PERS = "response person ";
     ...
     public static final String SAVED =  " added to DB";
     public static final String PROVIDED_TZ = " providedteudat zeut" ;
     public static final String EXISTS = " is exists in DB";
     public static final String CHILD_WITH_UUID = "child with provided uuid ";
